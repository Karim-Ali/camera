...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    ...
    <a href="adminOrder.php" class="w3-bar-item w3-button" style="width:33% !important">Orders</a>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="Menu">
    ...
    <div class="w3-container menu w3-padding-32 w3-white">
        <?php
          ...
          $q=mysqli_query($con,"select * from message") or die (mysqli_error());
          $result=mysqli_query($con,"select * from message");
          $result=mysqli_fetch_all($result,MYSQLI_ASSOC);
          foreach($result as $row){?><li>
              <h1 style="font-size:3vw;"><h2 class="w3-center"><?php echo $row['name']; ?></h2><br><b><?php echo $row['subject']; ?></b><span class="w3-right w3-tag w3-dark-grey w3-round"><?php echo $row['email'];?></span></h1>
                  <p class="w3-text-grey"><?php echo $row['text'];?><span class="w3-right"><a href="deletemessage.php?id=<?php echo $row['id'];?>"><input type="submit" class="num" value="Delete"></a></span></p><hr></li>
          <?php 
        }
          ?>
      </div>
