...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    <a href="#" class="w3-bar-item w3-button" style="width:33% !important">Menu</a>
...
<div class="w3-container w3-black w3-padding-64 w3-xxlarge" id="Menu">
         ...
         <?php
          ...
          foreach($result as $row){?>
              ...
              <h1 style="font-size:3vw;"><b> <?php echo $row['name']; ?></b> <span class="w3-right w3-tag w3-dark-grey w3-round"><?php echo $row['price'];?> <i class="fas fa-pound-sign"></i> </span></h1>
                  <p class="w3-text-grey"><?php echo $row['describtions'];?><span class="w3-right"><a href="Update.php?id=<?php echo $row['code'];?>"><input type="submit" class="num" value="Update"></a> <a href="delete.php?id=<?php echo $row['code'];?>"><input type="submit" class="num" value="Delete"></a></span></p>
    ...
    <input type="submit" class="btn w3-right" value="Add new">
    </form>
    </div>
</div>
</body>
